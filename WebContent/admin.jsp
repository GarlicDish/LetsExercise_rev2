			...
			<table class="table table-bordered table-hober" style="text-align: center; border:1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td><input class="form-control" type="text" name="adminid" maxlength="20" placeholder="아이디를 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>PW</h5></td>
						<td><input class="form-control" type="password" name="adminpw" maxlength="20" placeholder="비밀번호를 입력하세요."></td>
					</tr>
					<tr>
