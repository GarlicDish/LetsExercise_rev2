				...
				<div class="row">
					...
					<div class="col-xl-2 col-lg-3 sidebar fixed-top">
						...
						<ul class="navbar-nav flex-column mt-4">
							<!-- Dashboard -->
							<li class="nav-item">
								<a href="<%=request.getContextPath() %>/admin/login" class="nav-link text-white p-3 mb-2 current">
									<i class="bi bi-house-door-fill text-white fa-lg mr-3"></i>Dashboard
								</a>
							</li>
							<!-- Dashboard -->
							<li class="nav-item">
								<a href="<%=request.getContextPath() %>/admin/notice/list" class="nav-link text-white p-3 mb-2 sidebar-link">
