				...
				<div class="row">
					...
					<div class="col-xl-2 col-lg-3 sidebar fixed-top">
						...
						<ul class="navbar-nav flex-column mt-4">
							...
							<!-- Dashboard -->
							<li class="nav-item">
								<a href="<%=request.getContextPath() %>/admin/notice/list" class="nav-link text-white p-3 mb-2sidebar-link">
									<i class="bi bi-person-fill text-white fa-lg mr-3"></i>notice
								</a>
							</li>
							<!-- Dashboard -->
							<li class="nav-item">
								<a href="<%=request.getContextPath() %>/Admin/qna/list" class="nav-link text-white p-3 mb-2 current">
