...
public interface FindReplyDao {
	 ...
	 * @param fr
	 */
	int delete(Connection conn, FindReply fr);
	 ...
	 * @param fr   - 전달 객체
	 */
	int write(Connection conn, FindReply fr);
	 ...
	 */
	FindReply getFindReplyNumber(Connection conn, FindReply csr);
	 ...
	 */
	FindReply getFRdata(Connection conn, FindReply csr);
